...
hoistedDependencies:
  ...
  /jest-circus/29.6.3:
    jest-circus: private
  /jest-cli/29.6.3(@types/node@20.4.9)(ts-node@10.9.1):
    jest-cli: private
  /jest-config/29.6.3(@types/node@20.4.9)(ts-node@10.9.1):
    jest-config: private
  /jest-diff/29.6.3:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Wed, 23 Aug 2023 18:50:36 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - /fsevents/2.3.3
storeDir: /home/keyo/.local/share/pnpm/store/v3
